        ...
        <div id="customer-chat-widget" class="customer-chat customer-chat-widget loading-screen">
            <div class="customer-chat-header">
                ...
                <div class="customer-chat-header-menu">
                    ...
                    <a href="#" id="customer-chat-setting-toggle-sound" class="customer-chat-toggle-sound"><i class="icon-music"></i>
                        <div><?php echo $vars['ui']['toggleSoundLabel'] ?></div>
                    </a>
                    <a href="#" id="customer-chat-setting-toggle-scroll" class="customer-chat-toggle-scroll"><i class="icon-arrow-down"></i>
                        <div><?php echo $vars['ui']['toggleScrollLabel'] ?></div>
                    </a>
                    <a href="#" id="customer-chat-setting-toggle-emots" class="customer-chat-toggle-emots"><i class="icon-heart"></i>
                        <div><?php echo $vars['ui']['toggleEmoticonsLabel'] ?></div>
                    </a>
                    <a href="#" id="customer-chat-setting-toggle-show" class="customer-chat-toggle-show desktop-only"><i class="icon-resize-full"></i>
                        <div><?php echo $vars['ui']['toggleAutoShowLabel'] ?></div>
                    </a>
                    <a href="#" id="customer-chat-toggle-fs" class="desktop-only"><i class="icon-fullscreen"></i>
                        <div><?php echo $vars['ui']['toggleFullscreenLabel'] ?></div>
                    </a>
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="get">
                <div id="customer-chat-content-contact-form" class="customer-chat-content">
                    ...
                    <div class="customer-chat-content-message-input">
                        <input id="customer-chat-contact-mail" type="email" class="customer-chat-content-message-input-field" placeholder="<?php echo $vars['ui']['contactMailLabel'] ?>" />
                    </div>
                    <div class="customer-chat-content-message-input">
                        <input id="customer-chat-contact-mail" type="number" class="customer-chat-content-message-input-field" placeholder="Your phone number" />
                    </div>
                    <div class="customer-chat-content-message-input">
                    ...
                    <div class="customer-chat-content-row">
                        <a name="submitContact" type="submit" id="customer-chat-contact-send" class="customer-chat-content-button" style="margin: 0 auto;">Send<i class="icon-circle-arrow-right icon-white" style="margin: 3px 0 0 3px;"></i></a>
                    </div>
