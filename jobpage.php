...
<head>
    ...
    <!-- live chat -->
    <script type="text/javascript" src="//localhost/apa/projects/website/livechat/php/app.php?widget-init.js"></script>
...
<body>
    ...
    <div class="container">
        <div class="apollo">
            ...
            <p class="container content-offer text-left"> Apollo Group, our most valuable assets are our employees. We pride
                    ...
                    <div class="row job-content">
                        <div class="col-8 text-justify">
                            <ul class="text-left">
                                ...
                                <li><b>Location:</b> <span><?=desanitize($job_description['country']).', '.desanitize($job_description['county']); ?></span> </li>
                                <li><b>Deadline:</b> <span><?=desanitize(dMMY($job_description['deadline'])); ?></span> </li>
                            </ul>
                        </div>
                        <div class="col-4">
                            <div class="load-more text-center">
                                <a href="job_description.php?job_token=<?= desanitize($job_description['job_id']); ?>" class="btn btn-primary">APPLY NOW</a>
                            </div>
                        </div>
                    </div><br>
                </div>
        ...
        <div class="row ">
            <div class="col-10 job-box">
                <h2>ckeditor</h2>
                <form method="post" action="ckeditor.php" enctype="multipart/form-data">
                    ...
                    <div class="job-description form-group" id="toolbar-container">
                        <label for="post" class="">Post:</label>
                        <div id="editor">
                            <textarea class="ckeditor form-control" name="editor" style="height:20vh; width:35vw;">

                            </textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <input class="form-control btn btn-primary" name="submit" value="Submit">
                    </div>
                </form>
            </div>
        </div>
