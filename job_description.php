            ...
            <div class="col-10 job-box">
                <div class="job-description text-center">
                    ...
                    <ul class="text-left">
                        ...
                        <li><b>Location:</b> <span> <?= desanitize($job_desc['county']).', '.desanitize($job_desc['country']); ?></span> </li>
                        <li><b>Employment Type:</b> <span><?= sanitize($job_desc['employment_type']); ?></span> </li>
                        <li><b>Job Id:</b> <span><?= sanitize($job_desc['job_id']); ?></span> </li>
                        <li><b>Date added:</b> <span><?= sanitize(pretty_date($job_desc['date_added'])); ?></span> </li>
