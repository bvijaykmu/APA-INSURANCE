...
if(isset($_POST['submit_registration'])){
    ...
    $db -> query("INSERT INTO apa_job_applicants ( applicant_id, first_name, second_name, email, confirm_password) 
                                            VALUES('$applicant_id', '$first_name', '$second_name', '$email', '$confirm_password' ) ");
                ...
                <div class="job-description text-center">
                    ...
                    <form class="text-left" action="career_register.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" class="form-control my-input" aria-describedby="emailHelp" placeholder="Enter Name" value="<?= ((isset($first_name))? $first_name: ''); ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Second Name</label>
                            <input type="text" name="second_name" class="form-control my-input" aria-describedby="emailHelp" placeholder="Doe" value="<?= ((isset($second_name))? $second_name: ''); ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email address</label>
                            <input type="email" name="email" class="form-control my-input" aria-describedby="emailHelp" placeholder="Enter email" value="<?= ((isset($email))? $email: ''); ?>">
                        ...
                        <div class=" text-center new-bt">
                            <a href="<?= ((isset($loginURL))? $loginURL:''); ?>" class="btn btn-danger g-log"><i class="fab fa-google-plus-g"></i> Sign up with gmail</a>
                        </div>
                        <div class=" text-center new-bt">
                            <a href="<?php echo $linkedin ->getAuthUrl(); ?>" class="btn btn-primary t-log"><i class="fab fa-linkedin-in"></i> Sign up with Linkedin</a>
                        </div>
                        <div class=" text-center new-bt">
                            <a href="<?= ((isset($url))? $url: '#'); ?>" class="btn btn-primary t-log"><i class="fab fa-twitter"></i> Sign in with Twitter</a>
                        </div>
                        <div class=" text-center new-bt">
                            <a href="facebook/loginFB.php" class="btn btn-primary f-log"><i class="fab fa-facebook-f"></i>Sign up with facebook</a>
                        </div>
                    </form>
                    <hr>
                </div>
